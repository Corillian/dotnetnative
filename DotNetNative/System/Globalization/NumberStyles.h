#ifndef _DOTNETNATIVE_SYSTEM_GLOBALIZATION_NUMBERSTYLES_H_
#define _DOTNETNATIVE_SYSTEM_GLOBALIZATION_NUMBERSTYLES_H_
    ...
    namespace System
    {
        namespace Globalization
        {
            ...
            enum class NumberStyles
            {
                ...
                //     which the System.Char.IsWhiteSpace(System.Char) method returns true.
                AllowLeadingWhite = 1,
                ...
                //     characters are determined by the System.Globalization.NumberFormatInfo.PositiveSign
                ...
                //     value includes the System.Globalization.NumberStyles.AllowCurrencySymbol flag
                //     and the parsed string includes a currency symbol, the decimal separator character
                //     is determined by the System.Globalization.NumberFormatInfo.CurrencyDecimalSeparator
                //     property. Otherwise, the decimal separator character is determined by the System.Globalization.NumberFormatInfo.NumberDecimalSeparator
                //     property.
                ...
                //     character is determined by the System.Globalization.NumberFormatInfo.CurrencyGroupSeparator
                ...
                //     System.Globalization.NumberFormatInfo.NumberGroupSeparator property, and the
                //     number of digits in each group is determined by the System.Globalization.NumberFormatInfo.NumberGroupSizes
                //     property.
                AllowThousands = 64,
                ...
                //     and an integer. In other words, it successfully parses strings in the form nnnExx,
                //     nnnE+xx, and nnnE-xx. It does not allow a decimal separator or sign in the significand
                //     or mantissa; to allow these elements in the string to be parsed, use the System.Globalization.NumberStyles.AllowDecimalPoint
                ...
                //     and System.Globalization.NumberStyles.AllowExponent styles are used. This is
                ...
                //     and System.Globalization.NumberStyles.AllowHexSpecifier are used. This is a composite
                //     number style.
                Currency = 383,
                ...
                //     A string that is parsed with the System.Globalization.NumberStyles.AllowHexSpecifier
                //     style will always be interpreted as a hexadecimal value. The only flags that
                //     can be combined with System.Globalization.NumberStyles.AllowHexSpecifier are
                //     System.Globalization.NumberStyles.AllowLeadingWhite and System.Globalization.NumberStyles.AllowTrailingWhite.
                //     The System.Globalization.NumberStyles enumeration includes a composite style,
                //     System.Globalization.NumberStyles.HexNumber, that consists of these three flags.
                AllowHexSpecifier = 512,

                //
                // Summary:
                //     Indicates that the System.Globalization.NumberStyles.AllowLeadingWhite, System.Globalization.NumberStyles.AllowTrailingWhite,
                //     and System.Globalization.NumberStyles.AllowHexSpecifier styles are used. This
                //     is a composite number style.
                HexNumber = 515
            };
        }
